...
public class Producer extends Thread {
	...
	public Producer(BlockingQueue<PanGalacticThunderGurgler> queue) {
		this.queue = queue;
	...
	public void run() {
		...
		for (int i = 0; i < 420; i++) {
			...
			PanGalacticThunderGurgler gargleBlaster = new PanGalacticThunderGurgler("Chuck Norris", 42, map,
					"Der Anhalter gibt einem auch Auskunft darüber, auf welchen Planeten die besten Pangalaktischen Donnergurgler gemixt werden, wieviel man über den Daumen gepeilt dafür bezahlen muss, und welche freiwilligen Organisationen einem hinterher wieder auf die Beine helfen. Er enthält auch das Original Rezept, wie der Cocktail gemixt werden kann."
							+ "/r/n" + " Man nehme den Inhalt einer Flasche Alten Janx-Geist.\r\n"
							...
							+ "    Eine Olive wird als letzte (last but not least!) Zutat für den Pangalaktischen Donnergurgler benötigt./r/n"
							+ "");
