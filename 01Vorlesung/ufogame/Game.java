...
public class Game implements ITickableListener, IKeyboardListener {
	...
	public void init() {
		...
		ship = new Ship(screenWidth/2, 4 * screenHeight / 5, screenWidth / 9, screenWidth / 9, 
				"01Vorlesung\\assets\\ship.png");
		frameWork.addGameObject(ship);
		
		Ufo ufo = new Ufo(-20, screenHeight / 5, screenWidth / 10, screenWidth / 19, 3, 
	...
	public void shoot() {
		//create a projectile
		Projectile projectile = new Projectile(ship.getX()+20, ship.getY()-60, 
				ship.getWidth()/2, ship.getWidth()/2, 12, "01Vorlesung\\assets\\shot2p.png");
